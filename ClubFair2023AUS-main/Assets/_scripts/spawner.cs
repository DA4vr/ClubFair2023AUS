...
public class spawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        else if( w==8) Instantiate(crow,new Vector3(player.transform.position.x+distanceFromPlayer,2.55f,0),Quaternion.identity);
        }
        }
            if(Time.time>j)
            {
